package com.yunda.app.util.platform.adapter.common;
...
import com.yunda.app.util.platform.adapter.common.local.IWSDao;
import com.yunda.app.util.platform.adapter.common.local.WSManager;
import com.yunda.app.util.platform.vo.InterfaceConfigVO;
import com.yunda.app.util.platform.vo.InterfaceContent;
