...
<html>
  ...
  <body style="background-color: white;">
	   	<form action="#" id="editForm" style="display: inline;" class="tab">
    		<input id="roleId" type="hidden" name="roleId" field="roleId" class="easyui-textbox"/>
    		<table width="99%" border="0" cellspacing="0" cellpadding="0">
   				<tr>
   					...
   					<td align="left">
   						<input id="roleName" type="text" name="roleName" field="roleName" class="easyui-textbox" data-options="required:true,validType:['maxLength[25]']"/>
   					</td>
   				</tr>
   				<tr>
   					...
   					<td align="left">
   						<input id="roleMark" type="text" name="roleMark" field="roleMark" class="easyui-textbox" data-options="required:false,validType:['maxLength[100]']"/>
   					</td>
   				</tr>
   			</table>
   		</form>
