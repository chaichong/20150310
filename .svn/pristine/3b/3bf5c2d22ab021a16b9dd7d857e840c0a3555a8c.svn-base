	   	...
	   	<form action="#" id="editForm" style="display: inline;" class="tab">
	   		<table width="99%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td align="left">
						<input id="userId" type="text" name="userId" field="userId" readonly="readonly" class="easyui-textbox" data-options="required:true,validType:['maxLength[25]','username']"/>
					</td>
				</tr>
				<tr>
					...
					<td align="left">
						<input id="userName" type="text" name="userName" field="userName" class="easyui-textbox" data-options="required:true,validType:['maxLength[25]']"/>
					</td>
				</tr>
			</table>
		</form>
