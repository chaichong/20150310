...
public class RoleDaoTest extends SqlSessionDaoSupport  {
	...
	public void pageQuery() throws Exception {
		...
		List list = sqlSessionFactory.getObject().openSession().selectList("com.yunda.app.mapper.RoleMapper.pageQuery", queryParams, new RowBounds(pageQueryParams.getPageNo(),pageQueryParams.getPageSize()));
