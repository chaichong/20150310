...
<html>
  ...
  <body style="background-color: white;">
	   	<form action="#" id="addForm" style="display: inline;"  class="tab">
    		<input id="parentMenuCode" type="hidden" name="parentMenuCode" field="parentMenuCode"/>
    		...
    		<table width="99%" border="0" cellspacing="0" cellpadding="0">
   				...
   				<tr>
   					...
   					<td align="left">
   						<input type="text" name="menuCode" field="menuCode" class="easyui-textbox" data-options="required:true,validType:['maxLength[25]']"/>
   					</td>
   				</tr>
   				<tr>
   					...
   					<td align="left">
   						<input type="text" name="menuName" field="menuName" class="easyui-textbox" data-options="required:true,validType:['maxLength[25]']"/>
   					</td>
   				</tr>
   				<tr>
   					<td class="bule" align="right">
   					...
   					<td align="left">
   						<input type="text" name="menuMark" field="menuMark" class="easyui-textbox" data-options="required:false,validType:['maxLength[100]']"/>
   					</td>
   				</tr>
   			</table>
   		</form>
