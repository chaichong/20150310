	   	...
	   	<form action="#" id="addForm" style="display: inline;" class="tab">
	   		<table width="99%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td align="left">
						<input type="text" name="userId" field="userId" class="easyui-textbox" data-options="required:true,validType:['maxLength[25]','username']"/>
					</td>
				</tr>
				<tr>
					...
					<td align="left">
						<input type="text" name="userName" field="userName" class="easyui-textbox" data-options="required:true,validType:['maxLength[25]']"/>
					</td>
				</tr>
				<tr>
					<td class="bule" align="right">
