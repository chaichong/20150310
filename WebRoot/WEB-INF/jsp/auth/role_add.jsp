	   	...
	   	<form action="#" id="addForm" style="display: inline;" class="tab">
    		<table width="99%" border="0" cellspacing="0" cellpadding="0">
   				<tr>
   					...
   					<td align="left">
   						<input type="text" name="roleName" field="roleName" class="easyui-textbox" data-options="required:true,validType:['maxLength[25]']"/>
   					</td>
   				</tr>
   				<tr>
   					...
   					<td align="left">
   						<input type="text" name="roleMark" field="roleMark" class="easyui-textbox" data-options="required:false,validType:['maxLength[100]']"/>
   					</td>
   				</tr>
   			</table>
   		</form>
